...
//         error_va("shader not compiled\n%s\n",infolog);
//     }
//     return shader;
// }
// uint glutils_init_vert_shader(const char* code) { return glutils_init_shader(GL_VERTEX_SHADER, code); }
// uint glutils_init_frag_shader(const char* code) { return glutils_init_shader(GL_FRAGMENT_SHADER, code); }
...
//     if(not linked) {
//         char infolog[2048];
//         glGetProgramInfoLog(prog, 2048, 0, infolog);
//         error_va("program not linked\n%s\n", infolog);
//     }
//     return prog;
// }
...
//}
//
//void glutils_bind_program(uint prog) { glUseProgram(prog); }
//void glutils_unbind_program(uint prog) { glUseProgram(0); }
//
// template<typename T>
// void glutils_set_uniform(uint prog, const char* name, const T& value) {
//     int location = glGetUniformLocation(prog, name);
//     if(location < 0) warning_va("unknown shader variable name: %s", name);
//     else glsUniform(location, value);
// }
//
// // explicit template instantiation
// template void glutils_set_uniform(uint prog, const char* name, const bool& value);
// template void glutils_set_uniform(uint prog, const char* name, const int& value);
// template void glutils_set_uniform(uint prog, const char* name, const float& value);
// template void glutils_set_uniform(uint prog, const char* name, const vec3f& value);
// template void glutils_set_uniform(uint prog, const char* name, const mat4f& value);
