...
bool intersect_scene_first(Scene* scene, const ray3f& ray, float time, intersection3f& intersection);
bool intersect_scene_any(Scene* scene, const ray3f& ray, float time);
///@}
